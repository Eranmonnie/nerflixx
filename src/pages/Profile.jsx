...
const Profile = () => {
  ...
  return (
    ...
    <div>
      <div>
        <img
        className='block w-full object-cover h-[500px]' src={`https://assets.nflxext.com/ffe/siteui/vlv3/ca6a7616-0acb-4bc5-be25-c4deef0419a7/9088b423-46dd-4b5d-90ab-d68523264d15/NG-en-20231211-popsignuptwoweeks-perspective_alpha_website_medium.jpg`} alt="//" />
      ...
      {/* movie row */}
      <div>
        <h2 className="font-nsans-bold md:text-xl p-4 capitalize">Favourite Movies</h2>
